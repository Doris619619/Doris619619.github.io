...
// Official Douyin app icon from its public mobile download page; see third-party notices.
export const douyinIcon = '<img class="brand-mark brand-mark-douyin" src="/assets/organizations/douyin.jpg" alt="" width="24" height="24">';
