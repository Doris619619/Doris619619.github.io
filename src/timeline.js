...
export function homeTimeline(lang) {
  ...
  const rows = [
    ...
    { ...roles.itso, mark: "itso", text: en ? "I test the university’s AI platform and multi-model integrations, checking interface compatibility, streaming responses, and access permissions." : "参与校内 AI 平台与多模型接入测试，检查接口兼容性、流式响应和访问权限。", links: link(pathFor("about", lang) + "#experience", en ? "Work experience" : "工作经历") },
