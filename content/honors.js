// 文件用途：维护八项荣誉的正式名称、双语说明与已有证书及文章关联。
export const honors = [
  ...
  { id: "lingyu", date: "2025-04", category: "creative", title: { zh: "道扬书院《灵语》院刊征文比赛", en: "Diligentia College Lingyu Magazine Writing Competition" }, result: { zh: "二等奖 ·《未选择的路》", en: "Second Prize · The Road Not Chosen" }, noteSlug: "unselected-road" },
